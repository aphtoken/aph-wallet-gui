<template>
  <section id="dashboard--transaction-detail">
    ...
    <div class="body" v-if="$store.state.activeTransaction && $store.state.activeTransaction.symbol !== 'BTC'">
      <div class="section">
        <div class="row">
    ...
    <div class="body" v-if="$store.state.activeTransaction && $store.state.activeTransaction.symbol === 'BTC'">
      <div class="section">
        ...
        <div class="row">
          ...
          <div class="column">
            <div class="label">{{$t('block')}}</div>
            <div class="value purple">{{ $formatNumber($store.state.activeTransaction.blockheight) }}</div>
          </div>
        </div>
      </div>
      <div class="section">
        <div class="row">
          <div class="column">
            <div class="label">{{$t('to')}}</div>
            <aph-simple-transactions :transactions="btcToTransactions" :show-block-time="false"></aph-simple-transactions>
          </div>
        </div>
      </div>
      <div class="section">
        <div class="row">
          <div class="column">
            <div class="label">{{$t('networkFee')}}</div>
            <div class="value">{{ $formatNumber($store.state.activeTransaction.fees) }} BTC</div>
          </div>
          <div class="column">
            <div class="label">{{$t('Size')}}</div>
            <div class="value">{{ $formatNumber($store.state.activeTransaction.size) }} Bytes</div>
