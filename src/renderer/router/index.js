          ...
          children: [
            {
              path: '',
              components: {
                left: require('@/components/dashboard/Holdings').default,
                'right-first': require('@/components/dashboard/TopRightTile').default,
                'right-second': require('@/components/dashboard/Graph').default,
                'right-third': require('@/components/dashboard/RecentTransactions').default,
              },
            },
            {
              path: 'send',
              components: {
                left: require('@/components/dashboard/Holdings').default,
                'right-first': require('@/components/dashboard/Contacts').default,
                'right-second': require('@/components/dashboard/Send').default,
                'right-third': require('@/components/dashboard/TopRightTile').default,
              },
            },
            {
              path: 'confirming',
              components: {
                left: require('@/components/dashboard/Holdings').default,
                'right-first': require('@/components/dashboard/Send').default,
                'right-second': require('@/components/dashboard/RecentTransactions').default,
                'right-third': require('@/components/dashboard/TopRightTile').default,
              },
            },
          ],
